...
private:
  static Per_node_data<Allocator> _cap_allocator;
...
template<>
DECLARE_PER_NODE
Per_node_data<Obj_space_phys_entries::Node_allocator::Allocator> Obj_space_phys_allocator<Obj_space_phys_entries::Node_allocator::Type>::_cap_allocator("Cap");
